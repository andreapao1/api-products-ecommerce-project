						...
						<div>
							<div className="articlesect">
								...
								<div className="section-articles">
									...
									<button className="btn-car"><i className="fa-solid fa-cart-arrow-down"></i> Agregar al carrito</button>
									<div className="sect-datos">
										...
										<button className="brand-product btn-buy"><i className="fa-solid fa-truck"></i> Comprar</button>
